...
<html>
    ...
    <body>
        ...
        <div class="container mx-auto p-6">
            <h1 class="text-2xl font-bold text-center text-blue-600 mb-6">Add Part to Use</h1>
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
                <form action="MainServlet" class="space-y-4">
                    ...
                    <!-- Parts Selection -->
                    <div>
                        <label class="block text-gray-700 font-medium">Select Part:</label>
                        <select name="partid" class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:outline-none">
                            <option value="" disabled selected>-- Choose Part --</option>
                            <%
                                ArrayList<Parts> listpart = (ArrayList) session.getAttribute("SALE_STLISTPART");
                                if (listpart != null && !listpart.isEmpty()) {
                                    for (Parts part : listpart) {
                            %>
                            <option value="<%= part.getPartID()%>"><%= part.getPartID()%> - <%= part.getPartName()%></option>
                            <%
                                    }
                                }
                            %>
                    ...
                    <!-- Number of Parts -->
                    <div>
                        <label class="block text-gray-700 font-medium">Number of Parts Used:</label>
                    ...
                    <div class="flex justify-between">
                        ...
                        <input type="hidden" value="sale_addPartsUsed" name="action">
                    </div>

                    <div class="flex justify-between mt-4">
                        <a href="MainServlet?action=sale_completeSt" 
                ...
                <br/>
                <a href="MainServlet?action=sale_createSt1" 
