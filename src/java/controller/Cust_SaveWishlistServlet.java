 ...
 * @author Admin
 */
public class Cust_SaveWishlistServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (user != null) {
                ...
                if (listcar != null && !listcar.isEmpty()) {
                    ...
                    int result = d.createWishlist(custid, listcar);
                    if (result > 0) {
                    ...
                    request.setAttribute("ERROR", "Don't have any cars in wishlist!");
