 ...
 * @author Admin
 */
public class Sale_CarServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sale != null) {
                ...
                if(listCar != null && !listCar.isEmpty()) {
                    ...
                    response.sendRedirect("Sale_CarPage.jsp");
                } else {
                    request.setAttribute("ERROR", "Something wrong. Try again!");
                    request.getRequestDispatcher("Sale_CarPage.jsp").forward(request, response);
                }
            } else {
