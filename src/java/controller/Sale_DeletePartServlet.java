 ...
 * @author Admin
 */
public class Sale_DeletePartServlet extends HttpServlet {
            ...
            if (sale != null) {
                if (id != null) {
                    ...
                    if (result > 0) {
                        ...
                        request.getRequestDispatcher("MainServlet?action=sale_part").forward(request, response);
                    } else {
