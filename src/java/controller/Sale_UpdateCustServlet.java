 ...
 * @author Admin
 */
public class Sale_UpdateCustServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sale != null) {
                ...
                Customer user = cd.findCustomerByID(id);
                ...
                if (result > 0) {
                    ...
                    request.getRequestDispatcher("MainServlet?action=sale_updateCustPage").forward(request, response);
                } else {
