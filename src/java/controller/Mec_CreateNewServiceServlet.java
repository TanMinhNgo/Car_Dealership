 ...
 * @author Admin
 */
public class Mec_CreateNewServiceServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (mecha != null) {
                if (name != null) {
                    ...
                    int result = sd.createNewService(name, rate);
                    if (result > 0) {
                        ...
                        request.getRequestDispatcher("MainServlet?action=mec_createNewServicePage").forward(request, response);
                    } else {
