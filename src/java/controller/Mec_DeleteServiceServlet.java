 ...
 * @author Admin
 */
public class Mec_DeleteServiceServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (mecha != null) {
                if (id != null) {
                    ...
                    int result = sd.deleteService(id);
                    if (result > 0) {
                        ...
                        request.getRequestDispatcher("MainServlet?action=mec_servicePage").forward(request, response);
                    } else {
