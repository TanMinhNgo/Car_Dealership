 ...
 * @author Admin
 */
public class Sale_DeleteCarServlet extends HttpServlet {
            ...
            if (sale != null) {
                if (id != null) {
                    ...
                    if (result > 0) {
                        ...
                        request.getRequestDispatcher("MainServlet?action=sale_car").forward(request, response);
                    } else {
