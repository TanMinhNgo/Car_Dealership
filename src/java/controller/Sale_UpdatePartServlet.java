 ...
 * @author Admin
 */
public class Sale_UpdatePartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sale != null) {
                ...
                int result = pd.updatePart(part.getPartID(), name, purchaseprice, retailprice);
                if (result > 0) {
                    ...
                    request.getRequestDispatcher("MainServlet?action=sale_updatePartPage").forward(request, response);
                } else {
