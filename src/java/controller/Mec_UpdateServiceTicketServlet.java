 ...
 * @author Admin
 */
public class Mec_UpdateServiceTicketServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(mecha != null) {
                ...
                ServiceMechanic sm = smd.getServiceMechanicToUpdate(mecha.getId(), serviceTicketID, serviceID);
                if(sm != null) {
                    s.setAttribute("SERVICETICKET_UPDATE", sm);
